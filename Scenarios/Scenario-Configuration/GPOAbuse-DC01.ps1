...
The Office Admins group has write access over the SetWallpaper GPO linked to the EnterpriseUsersAndComputers OU
...
New-ADGroup -Name "Site Policy Admins" -GroupScope Global -Path $ou
